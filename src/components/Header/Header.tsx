...
const Header: React.FC = () => {
    ...
    const { email, isAuthenticated, isStaff } = useSelector((state: RootState) => state.user);
                    ...
                    <Nav className="ms-auto">
                        ...
                        {isAuthenticated ? (
                            <>
                                ...
                                {isStaff && (<Link to="/satellites/table" className="logo-button larger-font">Таблица спутников</Link>)}
